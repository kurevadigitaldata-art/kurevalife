...
export function KurevaLifeApp() {
  ...
  const exportPdf = () => {
    ...
    toast.success("PDF preparado y descargado. Revisa la carpeta Descargas de tu navegador.");
  };
